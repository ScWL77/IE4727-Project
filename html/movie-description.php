...
// Check if 'id' parameter is in the URL and is valid
        ...
        <td>
            <div class="movie-container">
                <div class="movie-content">
                    ...
                    <img src="<?php echo htmlspecialchars($movie['poster']); ?>" alt="<?php echo htmlspecialchars($movie['title']); ?> Poster" class="movie-info-poster">
                    
                    <!-- Movie Details on the Right -->
                    <div class="movie-info-details">
                        <div class="title-row">
                            <h1 class="title"><?php echo htmlspecialchars($movie['title']); ?></h1>
                            <img class="classification" src="<?php echo htmlspecialchars($movie['classification']); ?>" alt="Movie Classification">
                        </div>
                        <div class="details-row">
                            <div class="details-column">
                                <div class="detail-label">Synopsis</div>
                                <div class="detail-text"><?php echo htmlspecialchars($movie['synopsis']); ?></div>
                                <div class="detail-label">Genre</div>
                                <div class="detail-text"><?php echo htmlspecialchars($movie['genre']); ?></div>
                                <div class="detail-label">Cast</div>
                                <div class="detail-text"><?php echo htmlspecialchars($movie['cast']); ?></div>
                            </div>
                            <div class="details-column">
                                <div class="detail-label">Director</div>
                                <div class="detail-text"><?php echo htmlspecialchars($movie['director']); ?></div>
                                <div class="detail-label">Release Date</div>
                                <div class="detail-text"><?php echo htmlspecialchars($movie['release_date']); ?></div>
                                <div class="detail-label">Duration</div>
                                <div class="detail-text"><?php echo htmlspecialchars($movie['duration']); ?> minutes</div>
                                <div class="detail-label">Language</div>
                                <div class="detail-text"><?php echo htmlspecialchars($movie['language']); ?></div>
                            </div>
                        </div>

                        <!-- Button to go to the showtimes page -->
                        <a id="no-underline" class="unique-showtime-button" style="margin-left: 600px" href="showtimes.php?movie=<?php echo $movie['id']; ?>" id="movie-desc-btn">View Showtimes</a>
                    </div>
                </div>
            </div>
        </td>
